...
public class DriveCommands {
  ...
  private static final double[] translationPID = TunerConstants.translationPID;
  private static final double[] rotationPID = TunerConstants.rotationPID;
  private static final double ANGLE_MAX_VELOCITY = TunerConstants.maxAngularSpeed;
  private static final double ANGLE_MAX_ACCELERATION = TunerConstants.maxAngularAcceleration;
